...
export const STATIC_PAGE_METADATA = [
  ...
  { pageKey: "/tennessee-vacation-rentals", label: "Tennessee vacation rentals", group: "Main pages", title: "Luxury Tennessee Vacation Rentals - Smoky Mountains | Book Direct", description: "Browse luxury cabin rentals in Sevierville, Gatlinburg & Pigeon Forge TN. Private indoor pools, hot tubs & mountain views. Sleep up to 26. Book direct & save.", keywords: ["Tennessee vacation rentals", "luxury cabins Sevierville TN", "Gatlinburg luxury cabin rentals", "Pigeon Forge cabins with indoor pool", "Smoky Mountains large group cabins", "direct booking Tennessee cabins"] },
  { pageKey: "/north-carolina-vacation-rentals", label: "North Carolina vacation rentals", group: "Main pages", title: "Luxury North Carolina Waterfront Rentals - Lake Norman | Book Direct", description: "Browse luxury lakefront vacation rentals on Lake Norman & Lake Wylie NC near Charlotte. Private boat docks, hot tubs & lake views. Book direct & save.", keywords: ["North Carolina vacation rentals", "Lake Norman luxury rentals", "Mooresville lakefront homes", "Lake Wylie cabin rentals", "Charlotte waterfront vacation rentals", "rentals with private boat dock NC"] },
  ...
  { pageKey: "/review", label: "Guest reviews", group: "Content", title: "Guest Reviews - Nirvana Luxe Rentals", description: "Read verified guest reviews for Nirvana Luxe cabins and lake homes, shared by real families and groups." },
