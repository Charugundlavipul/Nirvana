                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;">
                                            <h2
                                                style="margin: 0px; font-size: 18px; font-family: Arial; color: rgb(0, 0, 0); font-weight: 600; line-height: 28px;">
                                                <span>Reservations</span><span>&nbsp;</span><span>Team</span>
                                            </h2>
                                            <div
                                                style="margin: 0px; font-weight: 500; color: rgb(0, 0, 0); font-size: 14px; line-height: 22px;">
                                                <span>VKR Ventures LLC</span>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="vertical-align: middle; height: 28px;">
                                                        ...
                                                        <td style="padding: 0px; color: rgb(0, 0, 0);"><a
                                                                ...
                                                                style="text-decoration: none; color: rgb(0, 0, 0); font-size: 14px;"><span>reservations@vkr-ventures.com</span></a>
                                                        </td>
                                                    </tr>
                                                    <tr style="vertical-align: middle; height: 28px;">
                                                        <td width="26" style="vertical-align: middle;">
    ...
    return (
        <div className="signature-preview-page">
            ...
            <div className="signature-container-box" style={{ marginTop: "40px" }}>
                <div className="preview-label">Reservations Team Signature Preview</div>
                <div id="signature-reservations" className="signature-container" dangerouslySetInnerHTML={{ __html: reservationsHTML }}></div>
